...
def backbone(backbone_name):
    ...
    elif 'vgg7' in backbone_name:
        from .vgg7 import VGG7Backbone as b
...
def assert_training_model(model):
    ...
    """
    assert(all(output in model.output_names for output in ['regression', 'regression_submodel', 'classification', 'classification_submodel'])), \
